...
- Name: TC012_DropDownBox.spec.ts >> @Regression_TC012_Drop Down Example
- Location: tests\TC012_DropDownBox.spec.ts:3:5
...
```ts
  ...
  2  | 
  3  | test('@Regression_TC012_Drop Down Example', async ({ page }) => {
  4  | 
